function y_n = TransientSuppression(x_n, fs, fd, BW, M)
%%
%  TRANSIENTSUPPRESSION -   notch filtering using transient
%   suppression.
%
% Y_N =  TRANSIENTSUPPRESSION(X_N, FS, FD, BW, M) performs a second
